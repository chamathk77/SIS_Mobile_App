...
import { ForgotPassword_EnterEmail_Response, ForgotPassword_EnterEmail_Request, LoginRequest, LoginResponse, ForgotPassword_EnterPin_Request, ForgotPassword_EnterPin_Response, ForgotPassword_CreateNewPassword_Request, ForgotPassword_CreateNewPassword_Response, SelectStudent_Response, SelectStudent_Request, ChangePassword_Request, ChangePassword_Response, GetStudent_Response, GetStudent_Request } from "../type/auth";
...
export const GetStudentProfile_Service  = createAsyncThunk(
  "auth/get-student-profile",
  async (getStudentProfileData: GetStudent_Request, { rejectWithValue }) => {
    try {
      const response = await apiClient.get<GetStudent_Response>(
        `/students/${getStudentProfileData.student_id}/profile`,
      );

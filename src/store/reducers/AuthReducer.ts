...
import { ForgotPassword_CreateNewPassword_Service, ForgotPassword_EnterEmail_Service, ForgotPassword_EnterPin_Service, login_Service } from '../../services/AuthService';
...
export const AuthSlice = createSlice({
    ...
    reducers: {
        ...
        setSchoolData: (state, action: PayloadAction<any>) => {
            state.Login.SchoolData = action.payload;
        },
        ...
        builder.addCase(ForgotPassword_EnterEmail_Service.fulfilled, (state, action) => {
        ...
        builder.addCase(ForgotPassword_EnterEmail_Service.rejected, (state, action) => {
        ...
        builder.addCase(ForgotPassword_EnterPin_Service.fulfilled, (state, action) => {
        ...
        builder.addCase(ForgotPassword_EnterPin_Service.rejected, (state, action) => {
        ...
        builder.addCase(ForgotPassword_CreateNewPassword_Service.pending, (state) => {
        ...
        builder.addCase(ForgotPassword_CreateNewPassword_Service.fulfilled, (state, action) => {
            console.log('Forgot Password Create New Password Fulfilled:', action.payload);
        ...
        builder.addCase(ForgotPassword_CreateNewPassword_Service.rejected, (state, action) => {
            console.log('Forgot Password Create New Password Rejected:', action.error);
            state.ForgotPasswordCreateNewPassword.loading = false;
            state.ForgotPasswordCreateNewPassword.error = action.error.message || 'An error occurred' as null;
            state.ForgotPasswordCreateNewPassword.success = false;
            state.ForgotPasswordCreateNewPassword.data = null;
        });
...
export const { setUserData, setSchoolData, setForgotPasswordEmail } = AuthSlice.actions;
